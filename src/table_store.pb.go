...
type PrimaryKeySchema struct {
	...
	Type                 *PrimaryKeyType   `protobuf:"varint,2,req,name=type,enum=main.PrimaryKeyType" json:"type,omitempty"`
	Option               *PrimaryKeyOption `protobuf:"varint,3,opt,name=option,enum=main.PrimaryKeyOption" json:"option,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type TableOptions struct {
	...
	BloomFilterType           *BloomFilterType `protobuf:"varint,3,opt,name=bloom_filter_type,json=bloomFilterType,enum=main.BloomFilterType" json:"bloom_filter_type,omitempty"`
...
type Condition struct {
	RowExistence         *RowExistenceExpectation `protobuf:"varint,1,req,name=row_existence,json=rowExistence,enum=main.RowExistenceExpectation" json:"row_existence,omitempty"`
...
type DescribeTableResponse struct {
	...
	TableStatus               *TableStatus               `protobuf:"varint,4,req,name=table_status,json=tableStatus,enum=main.TableStatus" json:"table_status,omitempty"`
...
type ReturnContent struct {
	ReturnType           *ReturnType `protobuf:"varint,1,opt,name=return_type,json=returnType,enum=main.ReturnType" json:"return_type,omitempty"`
...
type RowInBatchWriteRowRequest struct {
	Type                 *OperationType `protobuf:"varint,1,req,name=type,enum=main.OperationType" json:"type,omitempty"`
	RowChange            []byte         `protobuf:"bytes,2,req,name=row_change,json=rowChange" json:"row_change,omitempty"`
	Condition            *Condition     `protobuf:"bytes,3,req,name=condition" json:"condition,omitempty"`
	ReturnContent        *ReturnContent `protobuf:"bytes,4,opt,name=return_content,json=returnContent" json:"return_content,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
...
type GetRangeRequest struct {
	TableName                *string    `protobuf:"bytes,1,req,name=table_name,json=tableName" json:"table_name,omitempty"`
	Direction                *Direction `protobuf:"varint,2,req,name=direction,enum=main.Direction" json:"direction,omitempty"`
	ColumnsToGet             []string   `protobuf:"bytes,3,rep,name=columns_to_get,json=columnsToGet" json:"columns_to_get,omitempty"`
	TimeRange                *TimeRange `protobuf:"bytes,4,opt,name=time_range,json=timeRange" json:"time_range,omitempty"`
	MaxVersions              *int32     `protobuf:"varint,5,opt,name=max_versions,json=maxVersions" json:"max_versions,omitempty"`
...
type DescribeStreamResponse struct {
	...
	StreamStatus         *StreamStatus  `protobuf:"varint,5,req,name=stream_status,json=streamStatus,enum=main.StreamStatus" json:"stream_status,omitempty"`
...
type GetStreamRecordResponse_StreamRecord struct {
	ActionType           *ActionType `protobuf:"varint,1,req,name=action_type,json=actionType,enum=main.ActionType" json:"action_type,omitempty"`
...
type DefinedColumnSchema struct {
	Name                 *string            `protobuf:"bytes,1,req,name=name" json:"name,omitempty"`
	Type                 *DefinedColumnType `protobuf:"varint,2,req,name=type,enum=main.DefinedColumnType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
type IndexMeta struct {
	...
	IndexUpdateMode      *IndexUpdateMode `protobuf:"varint,4,req,name=index_update_mode,json=indexUpdateMode,enum=main.IndexUpdateMode" json:"index_update_mode,omitempty"`
	IndexType            *IndexType       `protobuf:"varint,5,req,name=index_type,json=indexType,enum=main.IndexType" json:"index_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func init() {
	proto.RegisterEnum("main.PrimaryKeyType", PrimaryKeyType_name, PrimaryKeyType_value)
	proto.RegisterEnum("main.PrimaryKeyOption", PrimaryKeyOption_name, PrimaryKeyOption_value)
	proto.RegisterEnum("main.BloomFilterType", BloomFilterType_name, BloomFilterType_value)
	proto.RegisterEnum("main.TableStatus", TableStatus_name, TableStatus_value)
	proto.RegisterEnum("main.RowExistenceExpectation", RowExistenceExpectation_name, RowExistenceExpectation_value)
	proto.RegisterEnum("main.ReturnType", ReturnType_name, ReturnType_value)
	proto.RegisterEnum("main.OperationType", OperationType_name, OperationType_value)
	proto.RegisterEnum("main.Direction", Direction_name, Direction_value)
	proto.RegisterEnum("main.StreamStatus", StreamStatus_name, StreamStatus_value)
	proto.RegisterEnum("main.ActionType", ActionType_name, ActionType_value)
	proto.RegisterEnum("main.DefinedColumnType", DefinedColumnType_name, DefinedColumnType_value)
	proto.RegisterEnum("main.IndexUpdateMode", IndexUpdateMode_name, IndexUpdateMode_value)
	proto.RegisterEnum("main.IndexType", IndexType_name, IndexType_value)
	proto.RegisterType((*Error)(nil), "main.Error")
	proto.RegisterType((*PrimaryKeySchema)(nil), "main.PrimaryKeySchema")
	proto.RegisterType((*PartitionRange)(nil), "main.PartitionRange")
	proto.RegisterType((*TableOptions)(nil), "main.TableOptions")
	proto.RegisterType((*TableMeta)(nil), "main.TableMeta")
	proto.RegisterType((*Condition)(nil), "main.Condition")
	proto.RegisterType((*CapacityUnit)(nil), "main.CapacityUnit")
	proto.RegisterType((*ReservedThroughputDetails)(nil), "main.ReservedThroughputDetails")
	proto.RegisterType((*ReservedThroughput)(nil), "main.ReservedThroughput")
	proto.RegisterType((*ConsumedCapacity)(nil), "main.ConsumedCapacity")
	proto.RegisterType((*StreamSpecification)(nil), "main.StreamSpecification")
	proto.RegisterType((*StreamDetails)(nil), "main.StreamDetails")
	proto.RegisterType((*CreateTableRequest)(nil), "main.CreateTableRequest")
	proto.RegisterType((*CreateTableResponse)(nil), "main.CreateTableResponse")
	proto.RegisterType((*UpdateTableRequest)(nil), "main.UpdateTableRequest")
	proto.RegisterType((*UpdateTableResponse)(nil), "main.UpdateTableResponse")
	proto.RegisterType((*DescribeTableRequest)(nil), "main.DescribeTableRequest")
	proto.RegisterType((*DescribeTableResponse)(nil), "main.DescribeTableResponse")
	proto.RegisterType((*ListTableRequest)(nil), "main.ListTableRequest")
	proto.RegisterType((*ListTableResponse)(nil), "main.ListTableResponse")
	proto.RegisterType((*DeleteTableRequest)(nil), "main.DeleteTableRequest")
	proto.RegisterType((*DeleteTableResponse)(nil), "main.DeleteTableResponse")
	proto.RegisterType((*LoadTableRequest)(nil), "main.LoadTableRequest")
	proto.RegisterType((*LoadTableResponse)(nil), "main.LoadTableResponse")
	proto.RegisterType((*UnloadTableRequest)(nil), "main.UnloadTableRequest")
	proto.RegisterType((*UnloadTableResponse)(nil), "main.UnloadTableResponse")
	proto.RegisterType((*TimeRange)(nil), "main.TimeRange")
	proto.RegisterType((*ReturnContent)(nil), "main.ReturnContent")
	proto.RegisterType((*GetRowRequest)(nil), "main.GetRowRequest")
	proto.RegisterType((*GetRowResponse)(nil), "main.GetRowResponse")
	proto.RegisterType((*UpdateRowRequest)(nil), "main.UpdateRowRequest")
	proto.RegisterType((*UpdateRowResponse)(nil), "main.UpdateRowResponse")
	proto.RegisterType((*PutRowRequest)(nil), "main.PutRowRequest")
	proto.RegisterType((*PutRowResponse)(nil), "main.PutRowResponse")
	proto.RegisterType((*DeleteRowRequest)(nil), "main.DeleteRowRequest")
	proto.RegisterType((*DeleteRowResponse)(nil), "main.DeleteRowResponse")
	proto.RegisterType((*TableInBatchGetRowRequest)(nil), "main.TableInBatchGetRowRequest")
	proto.RegisterType((*BatchGetRowRequest)(nil), "main.BatchGetRowRequest")
	proto.RegisterType((*RowInBatchGetRowResponse)(nil), "main.RowInBatchGetRowResponse")
	proto.RegisterType((*TableInBatchGetRowResponse)(nil), "main.TableInBatchGetRowResponse")
	proto.RegisterType((*BatchGetRowResponse)(nil), "main.BatchGetRowResponse")
	proto.RegisterType((*RowInBatchWriteRowRequest)(nil), "main.RowInBatchWriteRowRequest")
	proto.RegisterType((*TableInBatchWriteRowRequest)(nil), "main.TableInBatchWriteRowRequest")
	proto.RegisterType((*BatchWriteRowRequest)(nil), "main.BatchWriteRowRequest")
	proto.RegisterType((*RowInBatchWriteRowResponse)(nil), "main.RowInBatchWriteRowResponse")
	proto.RegisterType((*TableInBatchWriteRowResponse)(nil), "main.TableInBatchWriteRowResponse")
	proto.RegisterType((*BatchWriteRowResponse)(nil), "main.BatchWriteRowResponse")
	proto.RegisterType((*GetRangeRequest)(nil), "main.GetRangeRequest")
	proto.RegisterType((*GetRangeResponse)(nil), "main.GetRangeResponse")
	proto.RegisterType((*ListStreamRequest)(nil), "main.ListStreamRequest")
	proto.RegisterType((*Stream)(nil), "main.Stream")
	proto.RegisterType((*ListStreamResponse)(nil), "main.ListStreamResponse")
	proto.RegisterType((*StreamShard)(nil), "main.StreamShard")
	proto.RegisterType((*DescribeStreamRequest)(nil), "main.DescribeStreamRequest")
	proto.RegisterType((*DescribeStreamResponse)(nil), "main.DescribeStreamResponse")
	proto.RegisterType((*GetShardIteratorRequest)(nil), "main.GetShardIteratorRequest")
	proto.RegisterType((*GetShardIteratorResponse)(nil), "main.GetShardIteratorResponse")
	proto.RegisterType((*GetStreamRecordRequest)(nil), "main.GetStreamRecordRequest")
	proto.RegisterType((*GetStreamRecordResponse)(nil), "main.GetStreamRecordResponse")
	proto.RegisterType((*GetStreamRecordResponse_StreamRecord)(nil), "main.GetStreamRecordResponse.StreamRecord")
	proto.RegisterType((*ComputeSplitPointsBySizeRequest)(nil), "main.ComputeSplitPointsBySizeRequest")
	proto.RegisterType((*ComputeSplitPointsBySizeResponse)(nil), "main.ComputeSplitPointsBySizeResponse")
	proto.RegisterType((*ComputeSplitPointsBySizeResponse_SplitLocation)(nil), "main.ComputeSplitPointsBySizeResponse.SplitLocation")
	proto.RegisterType((*DefinedColumnSchema)(nil), "main.DefinedColumnSchema")
	proto.RegisterType((*IndexMeta)(nil), "main.IndexMeta")
	proto.RegisterType((*CreateIndexRequest)(nil), "main.CreateIndexRequest")
	proto.RegisterType((*CreateIndexResponse)(nil), "main.CreateIndexResponse")
	proto.RegisterType((*DropIndexRequest)(nil), "main.DropIndexRequest")
	proto.RegisterType((*DropIndexResponse)(nil), "main.DropIndexResponse")
	proto.RegisterType((*AddDefinedColumnRequest)(nil), "main.AddDefinedColumnRequest")
	proto.RegisterType((*AddDefinedColumnResponse)(nil), "main.AddDefinedColumnResponse")
	proto.RegisterType((*DeleteDefinedColumnRequest)(nil), "main.DeleteDefinedColumnRequest")
	proto.RegisterType((*DeleteDefinedColumnResponse)(nil), "main.DeleteDefinedColumnResponse")
	proto.RegisterType((*StartLocalTransactionRequest)(nil), "main.StartLocalTransactionRequest")
	proto.RegisterType((*StartLocalTransactionResponse)(nil), "main.StartLocalTransactionResponse")
	proto.RegisterType((*CommitTransactionRequest)(nil), "main.CommitTransactionRequest")
	proto.RegisterType((*CommitTransactionResponse)(nil), "main.CommitTransactionResponse")
	proto.RegisterType((*AbortTransactionRequest)(nil), "main.AbortTransactionRequest")
	proto.RegisterType((*AbortTransactionResponse)(nil), "main.AbortTransactionResponse")
}
...
var fileDescriptor_f723cea3e4fa0cb7 = []byte{
	...
	,
}
